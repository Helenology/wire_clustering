...
for i in range(n_replicates):
    ...
    sk_kmeans = sklearnKMeans(n_clusters=n_clusters, init='random', n_init=1, max_iter=100, random_state=i)
    ...
    # 2. cuML (GPU)
    start_time = time.time()
    cu_kmeans = cumlKMeans(n_clusters=n_clusters, init='random', n_init=1, max_iter=100, random_state=i)
    ...
    results_dict = {
        ...
        "GPU_ARI": gpu_aris,
        # Add the Scikit-learn CPU Normalized Mutual Information scores
        "CPU_NMI": cpu_nmis,
        # Add the cuML GPU Normalized Mutual Information scores
        "GPU_NMI": gpu_nmis
    }
